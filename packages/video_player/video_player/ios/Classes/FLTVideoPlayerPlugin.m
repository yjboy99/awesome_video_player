...
- (void)playBackSpeed:(double)volume {
    _player.setPlaybackParameters(PlaybackParameters((float)(volume < 0.3) ? 0.3 : ((volume > 3.0) ? 3.0 : volume)));
}
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  if ([@"init" isEqualToString:call.method]) {
    ...
    if ([@"dispose" isEqualToString:call.method]) {
      ...
      [player playBackSpeed:[argsMap[@"rate"] doubleValue]];
      result(nil);
